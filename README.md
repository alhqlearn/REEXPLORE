...
```
### Preparation
We provided our pre-trained model and large datasets in Git LFS format. Moreover, all the three datasets used for pre-training are provided in the following link `https://drive.google.com/drive/folders/1n-MfWsh3Y1d_HflR44dVPX1UbHuRq0BK?usp=sharing`. Download it and keep it in `dataset` folder.
## Training
